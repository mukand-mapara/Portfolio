...
export default function Contact() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      console.log("Sending data to Firestore: ", data); // Log data to verify
    ...
    <div className="row">
      ...
      >
        ...
        <div
          ...
          className="media d-flex gap-3 align-items-center"
        >
          <LuPhoneCall style={{}} className="mediaIcon" />
          <div className="mediaBody">
            <h6>Cell number</h6>
            <h4 style={{ fontSize: "24px" }}>{contact.number}</h4>
          </div>
        </div>
        ...
        <div className="media d-flex gap-3 align-items-center">
          ...
          <div className="mediaBody">
            <h6>Contact Me</h6>
            <h4 style={{ fontSize: "24px" }}>{contact.email}</h4>
          </div>
        </div>
        ...
        <div className="media d-flex gap-3 align-items-center">
          ...
          <div className="mediaBody">
            <h6>Location</h6>
            <h4 style={{ fontSize: "24px" }}>{contact.location}</h4>
          </div>
        </div>
      </motion.div>
